      ...
      <div className="max-w-[1440px] px-6 lg:px-[7.5rem] mx-auto grid grid-cols-1 pb-5 md:grid-cols-5 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            {["About Tripma", "How it works", "Careers", "Press", "Blog", "Forum"].map((item) => (
              <li key={item}>
                <Link href="#">
                  <span className="hover:text-indigo-600 cursor-pointer">{item}</span>
                </Link>
              </li>
            ))}
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {["Help Center", "Contact us", "Privacy policy", "Terms of service", "Trust and safety", "Accessibility"].map(
              (item) => (
                <li key={item}>
                  <Link href="#">
                    <span className="hover:text-indigo-600 cursor-pointer">{item}</span>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {["Tripma for Android", "Tripma for iOS", "Mobile site"].map((item) => (
              <li key={item}>
                <Link href="#">
                  <span className="hover:text-indigo-600 cursor-pointer">{item}</span>
                </Link>
