    ...
    <div className="md:flex md:w-fit mt-6 mb-10 border border-[#665AE0] rounded overflow-hidden">
      {paymentOptions.map((option) => (
        <button
          ...
          className={`flex w-full justify-center md:w-auto md:justify-normal items-center gap-2 px-5 py-[11.5px] text-xs 2xl:text-base font-medium transition-colors
            ${
              method === option.value
