    ...
    <div className="fixed inset-0 bg-[var(--color-purple-blue)]/20 flex items-center justify-center z-100">
      <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full">
        ...
        <p className="text-gray-400 text-lg mb-5">
          Upgrade your seat for only <strong>$199</strong>, and enjoy 45 percent more leg room, and seats that recline 40 percent more than economy.
        </p>
        <div className="flex text-lg justify-end gap-4">
          <button
            onClick={onCancel}
          ...
          <button
            onClick={onUpgrade}
            className="px-5 py-[11.5px] cursor-pointer bg-violet-600 text-white rounded hover:bg-violet-700 transition"
          >
            Upgrade for $199
          </button>
        </div>
