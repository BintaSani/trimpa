  ...
  return (
    <div className='w-full'>
        ...
        <h3 className='text-gray-600 text-2xl font-bold mb-4 mt-16'>
            Find unique <span className='text-[var(--color-purple-blue)]'>experiences</span>
        </h3>
        <p className='text-lg font-normal text-gray-400 mb-8'>
